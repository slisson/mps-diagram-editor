...
<language namespace="de.itemis.mps.editor.diagram.demo.activity" uuid="5a82b7b8-2303-45be-b960-4e3ff16e82ce" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="de.itemis.mps.editor.diagram.demo.activity#5725606875425068161" uuid="bce65e08-dc07-459a-82dc-c9e5a7039a98">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <external-templates />
      <usedLanguages>
        <usedLanguage>5a82b7b8-2303-45be-b960-4e3ff16e82ce(de.itemis.mps.editor.diagram.demo.activity)</usedLanguage>
